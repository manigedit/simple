...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_api_service__ = __webpack_require__(399);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__statement_account_statement_account__ = __webpack_require__(958);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__classes_comparison_utils__ = __webpack_require__(1334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_websocket_service__ = __webpack_require__(403);
...
var DashboardPage = /** @class */ (function () {
    function DashboardPage(navCtrl, navParams, storage, websocketService, apiService) {
        var _this = this;
    ...
    Object.defineProperty(DashboardPage.prototype, "listIsEmpty", {
        get: function () {
            if (this.listLoaded) {
    ...
    Object.defineProperty(DashboardPage.prototype, "userIsActive", {
        get: function () {
    ...
    DashboardPage.prototype.goToAllCoins = function () {
        var _this = this;
        this.listView = 'coins';
    ...
    DashboardPage.prototype.goToActivateCountryOfBirthPage = function () {
        this.navCtrl.push('CountryOfBirthPage', this.user);
    };
    DashboardPage.prototype.retrieveSorterFromStorage = function () {
        var _this = this;
        this.storage.get('sorter').then(function (sorter) {
            sorter ? _this.sorter = sorter : _this.sorter = 'popular';
        });
    };
    DashboardPage.prototype.retrieveFavoritesFromStorage = function () {
        var _this = this;
    ...
    DashboardPage.prototype.subscribeFavoritesToSocket = function () {
        var _this = this;
    ...
    DashboardPage.prototype.watchCoinUpdate = function (updatedCoin) {
    ...
    DashboardPage.prototype.retrieveCoinsFromStorage = function () {
        var _this = this;
    ...
    DashboardPage.prototype.removeFavorites = function (list) {
        var _this = this;
        return list.filter(function (coin) {
            return !_this.favorites.some(function (favorite) { return favorite.name === coin.name; });
        });
    };
    DashboardPage.prototype.isCoinsView = function () {
        return this.listView === 'coins';
    };
    DashboardPage.prototype.filterCoinsOnSearch = function (event) {
    ...
    DashboardPage.prototype.listHasCoins = function () {
        return this.list.length > 0 ? 'visible' : 'hidden';
    };
    DashboardPage.prototype.sorterChanged = function (event) {
        this.sortList(event);
        this.storage.set('sorter', event);
    };
    DashboardPage.prototype.listChanged = function (event) {
        var _this = this;
        this.list = [];
    ...
    DashboardPage.prototype.updateVirtualList = function (callBack) {
    ...
    DashboardPage.prototype.openItemAnimated = function (itemSlide, item) {
    ...
    DashboardPage.prototype.sortList = function (sorter) {
        switch (sorter) {
            case 'popular':
    ...
    Object.defineProperty(DashboardPage.prototype, "coinListLength", {
        get: function () {
    ...
    Object.defineProperty(DashboardPage.prototype, "isLoading", {
        get: function () {
    ...
    DashboardPage.prototype.selectedCoin = function (coin) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__statement_account_statement_account__["a" /* StatementAccountPage */], coin);
    };
    DashboardPage.prototype.trackByCoin = function (index, item) {
        return item.name;
    };
    DashboardPage.prototype.detectChange = function (priceChange) {
        return priceChange < 0;
    };
    DashboardPage.prototype.doRefresh = function (refresher) {
        this.apiService.refreshCoinList(refresher);
    };
    DashboardPage.prototype.addToFavorites = function (item, coin) {
        var _this = this;
    ...
    DashboardPage.prototype.removeFromFavorites = function (item, coin) {
...
var ComparisonUtils = /** @class */ (function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dashboard__ = __webpack_require__(1055);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_api_service__ = __webpack_require__(399);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_websocket_service__ = __webpack_require__(403);
...
var CoinListWalletPage = /** @class */ (function (_super) {
                ...
                },
                {
                    ...
                    handler: function (data) {
                        ...
                        if (value) {
                            ...
                            console.log("NUMERO DE MONEDEROS", _this.wallets.length);
    ...
    CoinListWalletPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-coin-list-wallet',template:/*ion-inline-start:"C:\Users\HP PRO\Documents\fiinwallet\app\src\pages\dashboard\dashboard.html"*/'<ion-header no-border>\n\n  <ion-navbar>\n\n    <ion-title>\n\n      <ng-container *ngIf="!search; else wallet">\n\n        {{ \'DASHBOARD_TITLE\' | translate }}\n\n      </ng-container>\n\n      <ng-template #wallet>\n\n        {{ \'DASHBOARD_TITLE_INITIAL\' | translate }}\n\n      </ng-template>\n\n    </ion-title>\n\n  </ion-navbar>\n\n  <ion-toolbar>\n\n    <ion-segment [(ngModel)]="listView" (ionChange)="listChanged($event)" color="primary-dark">\n\n      <ion-segment-button class="button-skewed" value="favorites" [ngClass]="{\'active\': listView === \'favorites\'}">\n\n        {{ \'DASHBOARD_TAB_FAVS\' | translate }}\n\n      </ion-segment-button>\n\n      <ion-segment-button class="button-skewed--inverse" value="coins" [ngClass]="{\'active\': listView === \'coins\'}">\n\n        {{ \'DASHBOARD_TAB_ALL\' | translate }}\n\n      </ion-segment-button>\n\n    </ion-segment>\n\n  </ion-toolbar>\n\n  <ion-toolbar class="sort-custom">\n\n    <ion-grid>\n\n      <ion-row>\n\n        <ion-col>\n\n        </ion-col>\n\n        <ion-col>\n\n          <ion-select\n\n            [style.visibility]="listHasCoins()"\n\n            [(ngModel)]="sorter"\n\n            [interface]="\'action-sheet\'"\n\n            (ionChange)="sorterChanged($event)">\n\n            <ion-option #item *ngFor="let sorter of sorters" [value]="sorter.value">{{sorter.name}}</ion-option>\n\n          </ion-select>\n\n        </ion-col>\n\n      </ion-row>\n\n    </ion-grid>\n\n\n\n  </ion-toolbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <ion-spinner class="big-loader" name="crescent" *ngIf="isCoinsView() && isLoading"></ion-spinner>\n\n  <ion-refresher *ngIf="isCoinsView()" (ionRefresh)="doRefresh($event)">\n\n    <ion-refresher-content pullingText="Pull to refresh"\n\n                           refreshingSpinner="crescent"\n\n                           refreshingText="Refreshing..."></ion-refresher-content>\n\n  </ion-refresher>\n\n  <ion-searchbar [(ngModel)]="searchTerm" *ngIf="isCoinsView()"\n\n                 (ionInput)="filterCoinsOnSearch($event)"></ion-searchbar>\n\n  <ion-list [virtualScroll]="list" [approxItemHeight]="\'70px\'"\n\n            [approxItemWidth]="\'100%\'" [virtualTrackBy]="trackByCoin" no-lines>\n\n    <ion-item-sliding #slidingItem *virtualItem="let coin">\n\n      <button ion-item #item (click)="selectedCoin(coin)" [ngClass]="{\'favorite\': coin.favorite}" detail-none>\n\n        <ion-avatar class="logo" item-start>\n\n          <img-loader [src]="coin.imageUrl" useImg></img-loader>\n\n        </ion-avatar>\n\n        <ion-label>\n\n          {{coin.name}}\n\n        </ion-label>\n\n        <span item-right class="price">\n\n          <span>{{coin.currency.symbol}} {{coin.price| numberFormatter: \'price\'}}</span>\n\n        </span>\n\n        <div class="change-icon" item-end>\n\n          <svg\n\n            viewBox="0 0 13 11"\n\n            class="delta"\n\n            [ngClass]="{\'negative\' : detectChange(coin.change)}"\n\n            version="1.1" xmlns="http://www.w3.org/2000/svg"\n\n          >\n\n            <title>Triangle</title>\n\n            <defs></defs>\n\n            <g id="Coin-row" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"\n\n               transform="translate(-344.000000, -41.000000)">\n\n              <polygon id="Triangle" stroke="#4EB92E" stroke-width="2" points="350.5 43 355 51 346 51"></polygon>\n\n            </g>\n\n          </svg>\n\n        </div>\n\n      </button>\n\n      <ion-item-options>\n\n        <button *ngIf="isCoinsView()" ion-button color="tertiary" (click)="addToFavorites(slidingItem, coin)">\n\n          Favorite\n\n        </button>\n\n        <button *ngIf="!isCoinsView()" ion-button color="danger" (click)="removeFromFavorites(slidingItem, coin)">\n\n          Remove\n\n        </button>\n\n      </ion-item-options>\n\n    </ion-item-sliding>\n\n  </ion-list>\n\n  \n\n  <div *ngIf="!userIsActive" class="empty-list" text-center padding>\n\n    <img src="./assets/imgs/mono-exit.png" alt="pin">\n\n    <button ion-button full color="primary" (click)="goToActivateCountryOfBirthPage()">{{ \'DASHBOARD_BUTTON_INITIAL\' | translate }}</button>\n\n  </div>\n\n</ion-content>'/*ion-inline-end:"C:\Users\HP PRO\Documents\fiinwallet\app\src\pages\dashboard\dashboard.html"*/,
        }),
...
}(__WEBPACK_IMPORTED_MODULE_1__dashboard__["a" /* DashboardPage */]));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dashboard__ = __webpack_require__(1055);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pipes_pipes_module__ = __webpack_require__(959);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__coin_list_wallet__ = __webpack_require__(1335);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ionic_image_loader__ = __webpack_require__(406);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ng_socket_io__ = __webpack_require__(179);
    ...
    DashboardPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__coin_list_wallet__["a" /* CoinListWalletPage */]),
...
;(function (global, factory) {
    true ? factory(__webpack_require__(793)) :
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StatementAccountPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_api_service__ = __webpack_require__(399);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment__ = __webpack_require__(793);
...
var StatementAccountPage = /** @class */ (function () {
    function StatementAccountPage(navCtrl, navParams, apiService) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.apiService = apiService;
    ...
    StatementAccountPage.prototype.subscribePriceHistoryDataNGX = function () {
        var _this = this;
    ...
    StatementAccountPage.prototype.subscribePriceHistoryData = function () {
        var _this = this;
        this.apiService.coinHistoryPriceListJS.subscribe(function (value) {
            if (!!value) {
                _this.data = value;
    ...
    StatementAccountPage.prototype.overrideCoin = function () {
        this.coin = {
            name: 'Bitcoin',
            code: 'BTC',
    ...
    StatementAccountPage.prototype.ionViewDidEnter = function () {
        this.chartMode = 'day';
        this.subscribePriceHistoryData();
        this.apiService.getPriceHistoryDay(this.coin);
    };
    StatementAccountPage.prototype.ionViewDidLeave = function () {
        this.apiService.coinHistoryPriceListJS.next(null);
        this.data = null;
    };
    Object.defineProperty(StatementAccountPage.prototype, "calculateChartHeight", {
        get: function () {
    ...
    StatementAccountPage.prototype.detectChange = function (priceChange) {
        return priceChange < 0;
    };
    StatementAccountPage.prototype.chartModeChanged = function (event) {
        this.data = null;
    ...
    StatementAccountPage.prototype.updatePrice = function (value) {
        if (!!value) {
    ...
    StatementAccountPage.prototype.updateDate = function (value) {
        if (!!value) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__number_formatter_number_formatter__ = __webpack_require__(960);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
